...
public static class TestOutputHelperExtension
{
    ...
    private static Logger CreateSerilogLogger(this ITestOutputHelper testOutputHelper, string outputTemplate)
    {
    ...
    ///     - and to Seq localhost:5341 (only in debug mode).
    /// </summary>
    public static ILoggerFactory CreateLoggerFactory<T>(this ITestOutputHelper testOutputHelper,
    ...
    ///     Inject TestOutput, Seq (debug only) and MockLogger (optional) to the application logging
    /// </summary>
    public static IServiceCollection AddTestLogging<T>(this IServiceCollection service,
        ITestOutputHelper testOutputHelper, MockLogger<T>? mockLogger = null,
