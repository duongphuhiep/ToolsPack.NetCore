...
public class RsaEncryptionTest
{
    ...
    public async Task AsymmetricEncryption_Using_OpenSsl_GeneratedKey()
    {
        ...
        _testOutputHelper.WriteLine("the encrypted payload in Base64 format: " +
                                    Convert.ToBase64String(encryptedPayload));
        _testOutputHelper.WriteLine(
            "the encrypted payload in Hex format: " + Utf8SealCalculator.ToHex(encryptedPayload));
